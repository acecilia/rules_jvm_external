 ...
 */
public final class GradleSnapshotUtil {
   ...
   * 
   * @param component the resolved component result to check
   * @return true if the component is a versioned (timestamped) SNAPSHOT
   */
  public static boolean isVersionedSnapshot(ResolvedComponentResult component) {
   ...
   * See: https://github.com/gradle/gradle/blob/1c1143f9b850f11cb6fef8f7b28405cb5ede45dc/platforms/software/dependency-management/src/main/java/org/gradle/api/internal/artifacts/repositories/resolver/MavenUniqueSnapshotComponentIdentifier.java#L55
   * 
   * @param component the resolved component result containing the SNAPSHOT version and identifier
   * @return the timestamped version string (e.g., "999.0.0-HEAD-jre-20250623.150948-114")
   */
  public static String extractSnapshotVersion(ResolvedComponentResult component) {
